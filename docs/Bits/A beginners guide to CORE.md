...
**NEWEST UPDATES**
Sep 18; Updated the res (github), cleaned up the account, and moved Obsidian to work exclusively on my laptop. fixed links (esp for [Hà-Binh](CΓÖíRE/Locations/Hà-Binh.md)). Fixed instances for [Dinh](CΓÖíRE/Characters/NPCs/Various NPCs/Dinh.md) and cleaned up some links. Updated [General Worldbuilding](CΓÖíRE/Bits/Worldbuilding/General Worldbuilding.md) and [SideQuests](CΓÖíRE/Bits/Game Mechanics/SideQuests.md).
